...
class TestBayesianNetwork:
    ...
    def test_d_separation__custom_graph_1(self):
    ...
    def test_d_separation__custom_graph_2(self):
    ...
    def test_d_separation__custom_graph_3(self):
    ...
    def test_d_separation__lc_repaired(self, bn_lc_repaired):
    ...
    def test_d_separation__lc_repaired(self, bn_alarm):
    ...
    def test_d_separation__lungcancer(self, bn_lungcancer):
